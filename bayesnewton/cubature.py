...
def variational_expectation_cubature(likelihood, y, post_mean, post_cov, extra, cubature=None):
    """
    ...
    weighted_log_likelihood_eval = w * likelihood.evaluate_log_likelihood(y, sigma_points, extra)
...
def log_density_cubature(likelihood, y, mean, cov, extra, cubature=None):
    """
    ...
    weighted_likelihood_eval = w * likelihood.evaluate_likelihood(y, sigma_points, extra)
